...
/**************************************************************************/
//
Emb_Max31865::Emb_Max31865(int8_t spi_cs, int8_t spi_mosi, int8_t spi_miso, int8_t spi_clk)
    : spi_dev(spi_cs, spi_clk, spi_miso, spi_mosi, 1000000, SPI_BITORDER_MSBFIRST, SPI_MODE1) {}
...
*/
/**************************************************************************/
Emb_Max31865::Emb_Max31865(int8_t spi_cs)
...
*/
/**************************************************************************/
bool Emb_Max31865::begin(max31865_numwires_t wires) 
{
  spi_dev.begin();
...
*/
/**************************************************************************/
uint8_t Emb_Max31865::readFault(void) 
{
...
*/
/**************************************************************************/
void Emb_Max31865::clearFault(void) 
{
...
*/
/**************************************************************************/
void Emb_Max31865::enableBias(bool b) 
{
  uint8_t t = readRegister8(MAX31865_CONFIG_REG);
  if (b) 
  {
...
*/
/**************************************************************************/
void Emb_Max31865::autoConvert(bool b) 
{
  uint8_t t = readRegister8(MAX31865_CONFIG_REG);
  if (b) 
  {
...
void Emb_Max31865::enable50Hz(bool b) 
{
  uint8_t t = readRegister8(MAX31865_CONFIG_REG);
  if (b) 
  {
...
*/
/**************************************************************************/
void Emb_Max31865::setWires(max31865_numwires_t wires) 
{
  uint8_t t = readRegister8(MAX31865_CONFIG_REG);
...
*/
/**************************************************************************/
float Emb_Max31865::temperature(float RTDnominal, float refResistor) 
{
...
*/
/**************************************************************************/
uint16_t Emb_Max31865::readRTD(void) 
{
  clearFault();
  enableBias(true);
  delay(10);
...
/**************************************************************************/
/*!
    @brief starts reading of the raw 16-bit value
*/
/**************************************************************************/
void Emb_Max31865::startReadRTD(void) 
{
  uint8_t t = readRegister8(MAX31865_CONFIG_REG);
  t |= MAX31865_CONFIG_1SHOT;
  writeRegister8(MAX31865_CONFIG_REG, t);
...
/*!
    @brief Read the raw 16-bit value from the RTD_REG
           run first startReadRTD()
    @return The raw unsigned 16-bit value, NOT temperature!
*/
/**************************************************************************/
uint16_t Emb_Max31865::getRTD(void) 
{
  uint16_t rtd = readRegister16(MAX31865_RTDMSB_REG);
...
/**************************************************************************/
/*!
    @brief Converts the raw 16-bit value to C
*/
/**************************************************************************/
float Emb_Max31865::getTemperature(float RTDnominal, float refResistor) 
{
  float Rt, Z1, Z2, Z3, Z4, temp;
...
uint8_t Emb_Max31865::readRegister8(uint8_t addr) 
{
  uint8_t ret = 0;
...
uint16_t Emb_Max31865::readRegister16(uint8_t addr) 
{
...
void Emb_Max31865::readRegisterN(uint8_t addr, uint8_t buffer[], uint8_t n) 
{
  addr &= 0x7F; // make sure top bit is not set

  port_writeMcp(cs_pin, LOW);
  spi_dev.write_then_read(&addr, 1, buffer, n);
  port_writeMcp(cs_pin, HIGH);
}

void Emb_Max31865::writeRegister8(uint8_t addr, uint8_t data) 
{
...
void Emb_Max31865::setCsPin(int8_t cs)
{
  cs_pin = cs;
}
